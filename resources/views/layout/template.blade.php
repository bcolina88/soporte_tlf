...
<head>
  ...
  <title>@yield('title', 'Inicio | Soporte Tec.') </title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('home') }}" class="logo">
     ...
     <span class="logo-lg"><b>Soporte</b> Tec.</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-file-text"></i> <span>Órdenes</span>
          ...
          <ul class="treeview-menu">
            @if(\App\Http\Controllers\RolesController::agregar(2))
             <li><a href="{{ route('ordenes.create') }}">Crear orden</a></li>
            @endif

            @if(\App\Http\Controllers\RolesController::ver(2))
            <li><a href="{{ route('ordenes.index') }}">Listado de órdenes</a></li>
            @endif
        ...
        <li ><a href="{{ route('resetPassword') }}"><i class="fa fa-key"></i> <span>Cambio de Contraseña</span></a></li>
        @endif
...
<div class="content-wrapper">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 <a href="#"><b> Soporte Tec</b></a>.</strong> All rights reserved.
  </footer>
